...
qemukernel() {
	...
	if [ x"$KVER" != x"5.10.33-shells" ]; then
		getfile shells-kernel-5.10.33-20dd010.tar.bz2 20dd01047c2a30744b41b66b075b0b1ade059fa3b32fef7c8a27397cc0351fc9
		tar xjf shells-kernel-5.10.33-20dd010.tar.bz2
	fi
