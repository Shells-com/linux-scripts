...
EOF
			...
			DEBIAN_FRONTEND=noninteractive run apt-get install -y locales-all python3-distro-info kmod qemu-guest-agent bash-completion nano ubuntu-release-upgrader-core
			;;
		*)
			# start from base
